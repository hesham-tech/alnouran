    ...
    <v-dialog v-model="dialogAddPreparation" max-width="600">
      <v-card class="rounded-xl border overflow-hidden bg-surface">
                ...
                >
                  ...
                  <div class="flex-1">
                    ...
                    <div class="text-h5 font-weight-black color-secondary">
                      {{ newPreparation.quantityGallon || 0 }}
                    </div>
                  </div>
                </div>
              </v-col>
        ...
        <div class="pa-6 border-t d-flex justify-end gap-2 bg-surface-variant bg-opacity-5">
          <v-btn color="secondary" variant="text" @click="dialogAddPreparation = false"
            >إلغاء</v-btn
          >
          <v-btn color="primary" @click="addPreparation">حفظ التحضيرة</v-btn>
        </div>
      </v-card>
    </v-dialog>
